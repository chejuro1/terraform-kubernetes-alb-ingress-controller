locals {
  aws_alb_ingress_controller_docker_image = "public.ecr.aws/eks/aws-load-balancer-controllerdocker.io/amazon/aws-alb-ingress-controller:v${var.aws_alb_ingress_controller_version}"
